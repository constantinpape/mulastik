...
from mu_net.datasets import get_isbi_loader
...
def training(project_directory,
    ...
    train_loader = get_isbi_loader(data_configuration_file, ndim=2)
    ...
    validation_loader = get_isbi_loader(validation_configuration_file, ndim=2)
...
def make_data_config(data_config_file, affinity_config, n_batches):
    ...
    template['loader_config']['num_workers'] = 1 * n_batches
...
def main():
    ...
    affinity_config = {'retain_mask': True}
